...
public class Utils {
     ...
     * @param unPremultiplyAlpha is a position, that determines, whether the bitmap needs to be converted from alpha premultiplied format (like Android keeps 'ARGB_8888' ones) to regular one; this position is ignored for 'RGB_565' bitmaps.
     */
     ...
     * @param premultiplyAlpha is a position, that determines, whether the Mat needs to be converted to alpha premultiplied format (like Android keeps 'ARGB_8888' bitmaps); the position is ignored for 'RGB_565' bitmaps.
     */
